...
average poem syllables, changing line size.
Many functions that are not currently employed due to time constraints.
"""
...
#         """
#         Changes line syllables.
#         Params:
#             line, Line obj
#             six, boolean indicating if we want 6 syllables.
#         """
#         current_syllables = line.count_syllables_in_line()
#         if six:
#             if current_syllables > 6:
#                 #chop the line and then see which we continue on with.
...
#                 #otherwise find closest difference to 6
